                    ...
                    <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600">
                      ...
                      >
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="Mean">DevOps</SelectItem>
                          <SelectItem value="Next.JS">Cloud Computing</SelectItem>
                          <SelectItem value="React.JS">MlOps</SelectItem>
                          <SelectItem value="React.JS">GenAIOps</SelectItem>
                        </SelectContent>
                      </Select>
                    </div>
                  </div>
