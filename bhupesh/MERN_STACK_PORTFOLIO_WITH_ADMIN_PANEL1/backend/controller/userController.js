...
export const register = catchAsyncErrors(async (req, res, next) => {
  ...
  const user = await User.create({
    ...
    phone,
    aboutMe,
    password, // Ensure password is hashed in the User schema pre-save hook
    portfolioURL,
    githubURL,
    instagramURL,
    twitterURL,
...
export const updatePassword = catchAsyncErrors(async (req, res, next) => {
  ...
  user.password = newPassword; // Ensure password is hashed in the User schema pre-save hook
  await user.save();
...
export const resetPassword = catchAsyncErrors(async (req, res, next) => {
  ...
  user.password = req.body.password; // Ensure password is hashed in the User schema pre-save hook
  user.resetPasswordToken = undefined;
  user.resetPasswordExpire = undefined;
